...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__rooms_rooms_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/rooms/rooms.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__rooms_room_selector_room_selector_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/rooms/room-selector/room-selector.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__temperature_temperature_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/temperature/temperature.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__temperature_temperature_dragger_temperature_dragger_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/temperature/temperature-dragger/temperature-dragger.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__electricity_electricity_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/electricity/electricity.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__electricity_electricity_chart_electricity_chart_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/electricity/electricity-chart/electricity-chart.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__weather_weather_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/weather/weather.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    DashboardModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__temperature_temperature_dragger_temperature_dragger_component__["a" /* TemperatureDraggerComponent */],
                __WEBPACK_IMPORTED_MODULE_5__rooms_room_selector_room_selector_component__["a" /* RoomSelectorComponent */],
                __WEBPACK_IMPORTED_MODULE_6__temperature_temperature_component__["a" /* TemperatureComponent */],
                __WEBPACK_IMPORTED_MODULE_4__rooms_rooms_component__["a" /* RoomsComponent */],
                __WEBPACK_IMPORTED_MODULE_8__electricity_electricity_component__["a" /* ElectricityComponent */],
                __WEBPACK_IMPORTED_MODULE_9__electricity_electricity_chart_electricity_chart_component__["a" /* ElectricityChartComponent */],
                __WEBPACK_IMPORTED_MODULE_10__weather_weather_component__["a" /* WeatherComponent */],
            ],
        })
    ], DashboardModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__electricity_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/electricity/electricity.component.ts");
...
var ElectricityChartComponent = /** @class */ (function () {
    function ElectricityChartComponent(theme, http, datePipe, ec) {
        var _this = this;
        this.theme = theme;
        this.http = http;
    ...
    ElectricityChartComponent.prototype.loadChart = function () {
        var _this = this;
        var username = 'admin';
        var password = '87654321';
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpHeaders */]();
        if (this.date != this.ec.date) {
            this.date = this.ec.date;
            this.http.get('https://graziano.herokuapp.com/thermostat/measurements?dateStart=' + this.ec.date.getTime(), { headers: headers }).subscribe(function (data) {
                // Read the result field from the JSON response.
                _this.data = data.map(function (d, index) { return ({
                    label: _this.datePipe.transform(d.date, 'HH:mm'),
                    value: d.temperature,
                }); });
    ...
    ElectricityChartComponent.prototype.ngAfterViewInitz = function () {
        var _this = this;
    ...
    ElectricityChartComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__nebular_theme__["o" /* NbThemeService */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_3__angular_common__["DatePipe"], __WEBPACK_IMPORTED_MODULE_4__electricity_component__["a" /* ElectricityComponent */]])
...
var ElectricityComponent = /** @class */ (function () {
    function ElectricityComponent(eService, themeService, http, decimalPipe) {
        var _this = this;
        ...
        this.type = '3 ORE';
        this.types = ['3 ORE', 'GIORNO', 'SETTIMANA'];
        this.stats = {
            minTemperature: 0.0,
            maxTemperature: 0.0,
            avgTemperature: 0.0
        ...
        // this.stats = {};
        // this.stats.avgTemperature = 23.45678;
    }
    ;
    ElectricityComponent.prototype.loadChart = function (t) {
        var _this = this;
        this.type = t;
        var username = 'admin';
        var password = '87654321';
        ...
        this.http.get('https://graziano.herokuapp.com/thermostat/measurementsStats?dateStart=' + this.date.getTime() + '&sensor_id=11', { headers: headers }).subscribe(function (data) {
            _this.stats = data;
        });
    };
    ...
    ElectricityComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__angular_common__["DecimalPipe"]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__core_data_electricity_service__["a" /* ElectricityService */], __WEBPACK_IMPORTED_MODULE_1__nebular_theme__["o" /* NbThemeService */], __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_4__angular_common__["DecimalPipe"]])
...
module.exports = "<nb-card size=\"large\">\n  <nb-tabset fullWidth>\n\n    <nb-tab tabTitle=\"Termostato\">\n\n      <div class=\"slider-container\">\n        <ngx-temperature-dragger [(value)]=\"temperature\" (power)=\"temperatureOff = !$event\"\n                                 [min]=\"tempMin\" [max]=\"tempMax\" [disableArcColor]=\"colors.layoutBg\"\n                                 [fillColors]=\"colors.temperature\">\n\n          <div class=\"slider-value-container\"  [ngClass]=\"{ 'off': temperatureOff }\">\n            <div class=\"value temperature\">\n              {{ temperatureOff ? '--' : temperature | number: '1.0-1'  }}\n            </div>\n            <div class=\"currentvalue temperature\">\n              {{ currentTemperature | number: '1.0-1' }}\n            </div>\n            <div class=\"desc\">\n            </div>\n          </div>\n\n        </ngx-temperature-dragger>\n      </div>\n\n      <div class=\"btn-group btn-temp btn-divided-group btn-outline-divided-group btn-group-full-width\" data-toggle=\"buttons\">\n\n\n        <label ngbButtonLabel class=\"btn btn-outline-success btn-icon\" (click)=\"increaseTemp()\">\n          <i class=\"nb-arrow-thin-up\"></i>\n        </label>\n\n        <label ngbButtonLabel class=\"btn btn-outline-success btn-icon\" (click)=\"decreaseTemp()\">\n          <i class=\"nb-arrow-thin-down\"></i>\n        </label>\n      </div>\n\n      <div [(ngModel)]=\"sensorDefault\"  ngbRadioGroup class=\"btn-group btn-sensors btn-divided-group btn-outline-divided-group \">\n\n\n        <label  ngbButtonLabel class=\"btn-success btn-avg btn-round btn-outline-primary\">\n          <input ngbButton type=\"radio\" value=\"0\"> MEDIA\n        </label>\n\n        <ng-container *ngFor=\"let sensor of sensors\">\n        <label *ngIf=\"sensor.active\" ngbButtonLabel class=\"btn-success btn-round btn-outline-primary\">\n          <input  ngbButton type=\"radio\" [value]=\"sensor.id\"> {{sensor.name}}\n        </label>\n        </ng-container>\n\n\n      <!-- <div *ngFor=\"let sensor of sensors\"[(ngModel)]=\"dividedButtonGroupOne\" ngbRadioGroup\n            class=\"btn-group btn-divided-group btn-outline-divided-group\">\n\n         <label *ngIf=\"sensor.active\" ngbButtonLabel class=\"btn-success btn-round btn-outline-primary\">\n           <input ngbButton type=\"radio\" value=\"sensor.name\"> {{sensor.name}}\n         </label>\n\n       </div>\n\n-->\n\n      </div>\n\n\n\n\n    </nb-tab>\n\n\n  </nb-tabset>\n</nb-card>\n"
...
var TemperatureComponent = /** @class */ (function () {
    function TemperatureComponent(theme, http) {
        var _this = this;
        this.theme = theme;
        this.http = http;
    ...
    TemperatureComponent.prototype.ngOnInit = function () {
        ...
        // headers.append('Authorization', 'Basic ' + btoa(username + ':' + password));
        // headers.set("Content-Type", "application/x-www-form-urlencoded");
        this.http.get('https://graziano.herokuapp.com/thermostat/sensors?thermostat_id=7', { headers: headers }).subscribe(function (data) {
            // Read the result field from the JSON response.
            ;
            _this.sensors = data;
        });
        this.http.get('https://graziano.herokuapp.com/thermostat/lastMeasurements?sensor_id=11', { headers: headers }).subscribe(function (data) {
            // Read the result field from the JSON response.
            console.log(data);
            _this.currentTemperature = data.temperature;
        });
        __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["a" /* Observable */].interval(5000).subscribe(function (x) {
            _this.http.get('https://graziano.herokuapp.com/thermostat/lastMeasurements?sensor_id=11', { headers: headers }).subscribe(function (data) {
                // Read the result field from the JSON response.
                console.log(data);
                _this.currentTemperature = data.temperature;
            });
    ...
    TemperatureComponent.prototype.increaseTemp = function () {
        if (this.temperature < this.tempMax && !this.temperatureOff) {
            this.temperature += 0.5;
        }
    };
    TemperatureComponent.prototype.decreaseTemp = function () {
        if (this.temperature > this.tempMin && !this.temperatureOff) {
            this.temperature -= 0.5;
        }
    };
    TemperatureComponent.prototype.changeTemp = function () {
        //np console.log(this.temperatureMode);
    };
    TemperatureComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__nebular_theme__["o" /* NbThemeService */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */]])
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_1__Observable__["Observable"]; });
...
__WEBPACK_IMPORTED_MODULE_0__Observable__["Observable"].prototype.timeInterval = __WEBPACK_IMPORTED_MODULE_1__operator_timeInterval__["a" /* timeInterval */];
